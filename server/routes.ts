...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/reports/:id/download", async (req, res) => {
    ...
    try {
      ...
      // Generate a simple PDF-like content as a string
      const reportContent = `
      -----------------------------
      ${report.name}
      ...
      This is an example report generated by GrowWise.
      In a real application, this would contain actual financial data.
      ...
      res.setHeader('Content-Disposition', `attachment; filename="${report.name.replace(/\s+/g, '_')}.txt"`);
